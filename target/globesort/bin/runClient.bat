...
%JAVACMD% %JAVA_OPTS% -ea -Xms256m -Xmx2048m -classpath %CLASSPATH% -Dapp.name="runClient" -Dapp.repo="%REPO%" -Dapp.home="%BASEDIR%" -Dbasedir="%BASEDIR%" globesort.GlobeSortClient %CMD_LINE_ARGS%
